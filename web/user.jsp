...
try
{
	...
	// 连接数据库
	final String url = "jdbc:mysql://localhost:3306/simplemain?autoReconnect=true&useUnicode=true&characterEncoding=utf-8&connectTimeout=2000&socketTimeout=10000";
